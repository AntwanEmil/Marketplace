<x-Layout>
  ...
  <div class="row m-0" style="padding:0.5% 0% 3% 0%">
    ...
    <!-- Product Image -->
    <div class="col-lg-5 col-md-5 col-sm-12 col-12 mb-2"><img src="{{asset('upload/items/'. $item->image)}}" style="width: 90%; height: 50%;" img-fluid w-100></div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 col-12">
      <form action="{{route('updateProduct',$item->id)}}" method="POST" style="margin:0%; border:1px solid rgb(0,0,0,0.2); border-radius:10px" enctype="multipart/form-data">
      {{csrf_field() }}  
