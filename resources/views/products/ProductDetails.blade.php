...
@endif
  ...
  <div class="row m-0" style="padding:0.5% 0% 3% 0%">
    ...
    <!-- Product Image -->
    <div class="col-lg-5 col-md-5 col-sm-12 col-12 mb-2"><img src="{{asset('upload/items/'. $item->image)}}" style="width: 90%; height: 90%;"></div>
    ...
    <div class="col-lg-3 col-md-3 col-sm-12 col-12 mb-3">
        ...
        <!-- Product Owner -->
        <div style="font-weight:bold" >{{$user->Storename}}</div>
        <!-- Product Price -->
